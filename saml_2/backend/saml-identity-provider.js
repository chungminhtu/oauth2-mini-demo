...
// Simple SLO endpoint that always returns success
app.get('/idp/slo', async (req, res) => {
    const { SAMLRequest, RelayState } = req.query;
    ...
    try {
      console.log('🚪 Processing SAML Logout Request...');
      ...
      <samlp:LogoutResponse xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol"
                            ...
                            InResponseTo="logout_request_id">
      ...
      // Send auto-submit form back to SP
      res.send(`
        <!DOCTYPE html>
        <html>
        <head><title>SAML Logout Response</title></head>
        <body onload="document.forms[0].submit()">
